      ...
      h("div", { class: "video-container" }, [
        ...
        h("div", { class: "video-header" }, [
          h("div", { class: "header-content" }, [
            h("h2", null, "Videos"),
            h("span", { class: "video-count" }, `${selectedVideos.value.size} selected`),
          ]),
          h(
            "button",
            {
          ...
          ? h("div", { class: "video-list" }, [
              ...props.videos.map((video) =>
                h(
                  "div",
                  {
                    class: ["video-item", { selected: selectedVideos.value.has(video.url) }],
                    onClick: () => toggleVideoSelection(video),
                  },
                  [
                    // Thumbnail or video type icon
                    h("div", { class: "video-thumbnail" }, [
                      video.thumbnail ? h("img", { src: video.thumbnail }) : h("i", { class: "fas fa-video" }),
                      video.duration && h("span", { class: "video-duration" }, formatDuration(video.duration)),
                    ]),
                    // Video info
                    h("div", { class: "video-info" }, [
                      ...
                      h("div", { class: "video-type" }, [
                        h("i", {
                          class: video.type === "youtube" ? "fab fa-youtube" : "fas fa-play-circle",
                        }),
        ...
        props.error &&
          h("div", { class: "error-message" }, [h("i", { class: "fas fa-exclamation-circle" }), props.error]),

        // Analyze button with single play icon
